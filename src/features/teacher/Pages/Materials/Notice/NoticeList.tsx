                                            ...
                                            <Grid size={12}>
                                                <Box>
                                                    {notices?.map((notice, index) => (
                                                        <Link to={`/teacher/resource-update/${notices?._id}`} style={{ textDecoration: "none" }}>
                                                            <Card variant="outlined"
                                                                ...
                                                                <Box sx={{ width: "97%", display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                                                    <Box>
                                                                        <Typography variant="h6" sx={{ fontSize: "14px", fontWeight: "600" }} color="#475467">Notice {index + 1}</Typography>
                                                                        <Typography variant="subtitle1" sx={{ fontSize: "14px", fontWeight: "500" }} color="#475467">{notice?.notice}</Typography>
                                                                    </Box>
